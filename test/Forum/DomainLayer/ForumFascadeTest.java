...
public class ForumFascadeTest {
   ...
   //     ForumFascade instance = new ForumFascade();
    ...
    public void testLogin() throws Exception {
     ...
     assertEquals( fInstance.getInstance().getOnlineMembers().size() , 0);
        instance.login(username, password);
       assertEquals( fInstance.getInstance().getOnlineMembers().size() , 1);
   ...
   //    assertTrue  (  fInstance.getMessage(1).getReplies() == null);
    ...
    public void testSearchByAuthor() {
      ...
      //       expResult = "no more old";
//                assertEquals(expResult, result[1].getMessage().getBody());
    }
